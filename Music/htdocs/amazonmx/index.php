<!DOCTYPE html>
  ...
  <head>
    ...
    <body style="background-image: url('images/wallpaper.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">


<a href="https://namso-gen.com/" style="background-color:#007BFF;color:#FFFFFF;padding:10px;border-radius:5px;text-decoration:none;display:inline-block;box-shadow:0px 0px 10px rgba(0,0,0,0.5);">Gerar Cards</a>
    
/
<a href="/painel/amazon" style="background-color:#007BFF;color:#FFFFFF;padding:10px;border-radius:5px;text-decoration:none;display:inline-block;box-shadow:0px 0px 10px rgba(0,0,0,0.5);">CHECKER AMAZON BR (ON)</a>


    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title> Checker Allbins 🌮</title>
        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-body text-center" style="background-color: black;">
              <h4  class="title mb-2">ModderVTC (AMAZON MEXICO)<img src="" class="rounded" width="65"</h4>
              <textarea style="height: 8.06rem;" class="form-control text-center form-checker mb-2" placeholder="coloque a lista de GG😎😎"></textarea>
              ...
              <button class="btn btn-danger btn-stop text-white" style="width: 49%; float: right;" disabled><i class="fa fa-stop"></i> PARAR</button>
                              <input type="text" class="input_text blackbb text-white form-control" id="cookie1" name="cookie" value="" placeholder="COOKIE-AUDIABLE.COM"   style="warning: 35%; float: left;">
<input type="text" class="input_text blackbb text-white form-control" id="cookie2" name="cookie" value="" placeholder="COOKIE- MEXICO"   style="warning: 35%; float: left;">
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card">
            <div class="card-body" style="background-color: black;">
              ...
              <h5 class="title"><img src="" width="15"</i>   Reprovadas<span class="badge badge-danger float-right reprovadas">0</span></h5><hr>

              <h5 class="title"><img src="" width="15"</i> Testadas<span class="badge badge-warning float-right testadas">0</span></h5><hr>

              <h5 class="title mb-0"><img src="" width="15"</i> Carregadas<span class="badge badge-info float-right carregadas">0
			  </div>
			 </div>
            </div>
          </div>
...
Swal.fire({
  ...
  icon:"warning",
  html: "<font style=color:#1C1C1C>NÃO VAZE!!!!  BY: MODDERVTC",
  confirmButtonText: "Fds",
  confirmButtonColor: "#3CB371",
    ...
    $('.btn-play').click(function() {
      ...
      if (total > 9999999) {
        Swal.fire({
          title: 'Limite de 50 Linhas Exedido!',
          icon: 'warning',
          showConfirmButton: false,
          toast: true,
          position: 'top-end',
